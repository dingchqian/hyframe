...
class ListBuilder
{
    ...
    private $_template = '/admin/builder/list';      // 模版
    ...
    public function __construct() {
        ...
        [$module, $controller, $action] = explode('/', substr($requestUri, 1));
        $assign['module'] = $module;
        $assign['controller'] = $controller;
        $assign['action'] = $action;
        $assign['uri'] = $requestUri;
    ...
    public function url($action, $params = []) {
        $url = '/' . $this->assign['module'] . '/' . $this->assign['controller'] . '/' . $action;
        if(!empty($params)) {
    ...
    public function addTopButton($type, $attribute = null) {
        ...
        switch ($type) {
            case 'addnew':  // 添加新增按钮
                ...
                $my_attribute['href']  = $this->url('add');
            ...
            case 'delete': // 添加删除按钮(我没有反操作，删除了就没有了，就真的找不回来了)
                ...
                $my_attribute['href']  = $this->url($set_status_url, ['status' => 'delete']);
            ...
            case 'resume':  // 添加启用按钮(禁用的反操作)
                ...
                $my_attribute['__href__']  = $this->url($set_status_url, ['status' => 'resume']);
            ...
            case 'forbid':  // 添加禁用按钮(启用的反操作)
                ...
                $my_attribute['__href__']  = $this->url($set_status_url, ['status' => 'forbid']);
    ...
    public function addRightButton($type, $attribute = null) {
        ...
        switch ($type) {
            case 'edit':  // 编辑按钮
                ...
                $my_attribute['href']  = $this->url('edit');
            ...
            case 'forbid':  // 改变记录状态按钮，会更具数据当前的状态自动选择应该显示启用/禁用
                ...
                $my_attribute['0']['__href__']  = $this->url($set_status_url, ['status' => 'resume', 'ids' => '__data_id__']);
                //$my_attribute['0']['href']  = 'javascript:void(0)';

                $my_attribute['1']['title'] = '禁用';
                $my_attribute['1']['class'] = 'label label-warning ajax-get confirm';
                $my_attribute['1']['__href__']  = $this->url($set_status_url, ['status' => 'forbid', 'ids' => '__data_id__']);
            ...
            case 'hide':  // 改变记录状态按钮，会更具数据当前的状态自动选择应该显示隐藏/显示
                ...
                $my_attribute['2']['__href__']  = $this->url($set_status_url, ['status' => 'show', 'ids' => '__data_id__']);
                //$my_attribute['2']['href'] = 'javascript:void(0)';
                $my_attribute['1']['title'] = '隐藏';
                $my_attribute['1']['class'] = 'label label-info ajax-get confirm';
                $my_attribute['1']['__href__']  = $this->url($set_status_url, ['status' => 'hide', 'ids' => '__data_id__']);
                //$my_attribute['1']['href']  = 'javascript:void(0)';
            ...
            case 'recycle':
                ...
                $my_attribute['__href__']  = $this->url($set_status_url, ['status' => 'recycle', 'ids' => '__data_id__']);
            ...
            case 'restore':
                ...
                $my_attribute['__href__']  = $this->url($set_status_url, ['status' => 'restore', 'ids' => '__data_id__']);
                //$my_attribute['href'] = 'javascript:void(0)';
